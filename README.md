This ain't a readme. It's documentation, roadmap and architectural notes.
...
- Auto-fill of pairs in the grid; automatic coloured pairing
- Auto-fill of strip if there's only one option
- Auto-colouring of strip
